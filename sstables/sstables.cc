...
static entry_descriptor make_entry_descriptor(sstring sstdir, sstring fname, sstring* const provided_ks, sstring* const provided_cf) {
    ...
    return entry_descriptor(sstdir, ks, cf, generation_from_value(boost::lexical_cast<generation_value_type>(generation)), version, sstable::format_from_sstring(format), sstable::component_from_sstring(version, component));
}
