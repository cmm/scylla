...
db::config::config(std::shared_ptr<db::extensions> exts)
    ...
    , enable_sstables_md_format(this, "enable_sstables_md_format", value_status::Unused, true, "Enable SSTables 'md' format to be used as the default file format")
    , sstable_format(this, "enable_format", value_status::Used, "md", "Default format used to write sstable files", {"mc", "md", "me"})
