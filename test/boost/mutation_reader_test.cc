...
SEASTAR_THREAD_TEST_CASE(test_multishard_streaming_reader) {
    ...
    do_with_cql_env_thread([&] (cql_test_env& env) -> future<> {
        ...
        auto tested_reader = mutation_fragment_v1_stream(make_multishard_streaming_reader(env.db(), schema, make_reader_permit(env),
...
SEASTAR_THREAD_TEST_CASE(test_clustering_combining_of_empty_readers) {
    ...
    auto r = mutation_fragment_v1_stream(make_clustering_combined_reader(
