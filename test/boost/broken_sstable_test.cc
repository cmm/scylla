...
static future<> broken_sst(sstring dir, generation::type generation, schema_ptr s, sstring msg, std::optional<sstring> sst_name,
...
static future<> broken_sst(sstring dir, generation::type generation, sstring msg, std::optional<sstring> sst_name = std::nullopt) {
